...
/************************************************************************
 *  Purpose: Thread safe function that signals that there is data in the 
 *  queue
 *
 *  Precondition:
 *      Queue is valid, must have data to put in queue
 *
 *  Postcondition:
 *      Data will be put in queue.
 * *********************************************************************/
void Queue_Put(queue_t queue, char * buffer);

/************************************************************************
 *  Purpose: The provide thread safe a blocked call to wait for data to 
 *  be in the queue
 *  
 *  Precondition: 
 *      Queue is valid, data is in the queue
 *
 *  Postcondition:
